...
<div style="max-width:1200px; margin:auto;">
  ...
  <p>
    Start by loading in a CSV file with your data from the home page. <a href="https://en.wikipedia.org/wiki/Comma-separated_values">CSV</a> is the simplest and easiest format for exchanging data between 
    systems. There is a link to an example file you can use as a template (see below).
  </p>
  <p>If you are using Excel or Access to manage your specimen data then make sure to set the encoding 
    to <a href="https://www.motionpoint.com/blog/the-importance-of-character-encoding-website-translation-user-experience">UTF-8</a> when you export your records to CSV format, otherwise special characters like degree symbols will get scrambled. 
    Most other database systems (such as Specify) use UTF-8 by default.
  </p>
  <p>
    <em>
      Note that no specimen data are stored or sent over the internet when using this tool. The source code is <a href="https://github.com/NSCF/SvelteSpecifyLabels">available on Github</a> and can be checked
